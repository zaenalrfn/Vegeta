  ...
  return (
    <>
      ...
      <div className="my-4 relative">
        <Input className="w-full" type="text" placeholder="" prefix="text-Rp" value={price?.min} onChange={(val) => {
          setPrice({
            ...price,
      ...
      <div className="my-4 relative">
        <Input className="w-full" type="text" placeholder="" prefix="text-Rp" value={price?.max} onChange={(val) => {
          setPrice({
            ...price,
